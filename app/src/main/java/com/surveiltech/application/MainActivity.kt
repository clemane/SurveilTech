...
import com.surveiltech.application.chatapi.ApiInterface
import com.surveiltech.application.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), NetworkFragment.OnListFragmentInteractionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val interfaceMenu =
            binding.drawerNavigation.menu.addSubMenu(getString(R.string.interfaces_submenu))
    ...
    override fun onListFragmentInteraction(item: DeviceWithName?, view: View) {
        val bundle = Bundle().apply {
            putLong("deviceId", item?.deviceId!!)
            putString("deviceIp",item.ip.toString())
        }
